...
const Table = ({ filterData }) => {
  let { cryptoData, error } = useContext(CryptoDataContext);
          ...
          <table className="w-full table-auto overflow-x-auto">
            <thead className="capitalize text-base text-gray-100 font-medium border-b border-gray-100">
              <tr>
                ...
                <th className="py-1" title="Price of coin in selected currency">
                  Price
                </th>
                <th
                  className="py-1"
...
"
                  ...
                  >
                    <td className="py-4">
                      <div className="flex flex-row justify-evenly">
                        <button className="border-0 bg-none cursor-pointer">
                          <svg
                            className="fill-gray-100 hover:fill-gold-100"
                            height="30"
                            width="30"
                            version="1.1"
                            id="Capa_1"
      ...
      C22.602,0.567,25.338,0.567,26.285,2.486z"
                    ...
                    <td className="py-4 first-letter:font-bold">
